...
def absolute_path_to_app_data_url(absolute_path: str) -> str:
    """Convert an absolute file path under app_data to an HTTP-relative /app_data/... URL."""
    app_data_dir = get_app_data_directory_env()
    if app_data_dir and absolute_path.startswith(app_data_dir):
        relative = os.path.relpath(absolute_path, app_data_dir).replace("\\", "/")
